...
public:
    SampleBuffer() {
        ...
        m_buffer_range = std::ranges::subrange(m_buffer);
        m_padded_buffer_range = std::ranges::subrange(m_buffer.begin() + 1, m_buffer.end());
    }
    ...
    std::ranges::subrange<float*>& as_subrange_padded() {
        return m_padded_buffer_range;
    }
...
private:
    ...
    std::ranges::subrange<float*> m_padded_buffer_range;
};
